insert into musinsadb.member(member_id, registration_date, update_date) values (1 ,CURRENT_DATE() ,CURRENT_DATE());
insert into musinsadb.member(member_id, registration_date, update_date) values (2 ,CURRENT_DATE() ,CURRENT_DATE());
